console.log("%cBlog-Doc for Deta Space", "font-weight:bold; font-size:48px;")
console.log("The simplest Node.js CMS and SSG! → https://github.com/LebCit/blog-doc-space")
